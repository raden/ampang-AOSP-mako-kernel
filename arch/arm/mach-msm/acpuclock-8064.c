...
//	{ 1, {    81000, PLL_8, 0, 0x00 }, L2(0),   800000 },
	{ 1, {    81000, HFPLL, 0x06 }, L2(0),   700000 },//use HFPLL 
	{ 1, {   189000, HFPLL, 2, 0x0E }, L2(5),   725000 },
//	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   825000 },
//	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   875000 },
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(5),   775000 }, // I think we stick to the original calculation
...
static struct acpu_level tbl_faster[] __initdata = {
	{ 1, {    81000, HFPLL, 0x06 }, L2(0),   700000 },//use HFPLL 
//	{ 1, {   192000, HFPLL, 2, 0x20 }, L2(5),   725000 },// this ..equal to 432,000 and seems not possible to use HFPLL
	{ 1, {   189000, HFPLL, 2, 0x0E }, L2(5),   725000 },
//	{ 1, {   384000, HFPLL, 2, 0x24 }, L2(5),   775000 }, this is wrong.. this equal to 486,000
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(5),   775000 }, // I think we stick to the original calculation
	//{ 1, {   486000, HFPLL, 2, 0x24 }, L2(5),   875000 },
	{ 0, {   540000, HFPLL, 2, 0x28 }, L2(5),   800000 },
	//{ 1, {   594000, HFPLL, 1, 0x16 }, L2(5),   900000 },
	//{ 0, {   648000, HFPLL, 1, 0x18 }, L2(5),   925000 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(5),   825000 }, // this is correct
